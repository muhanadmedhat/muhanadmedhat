...
const muhanad = {
  ...
  focus:      ["Web Development", "Backend APIs", "Problem Solving"],
  stack:      ["C#/.NET", "React", "Angular", "Node.js", "SQL Server"],
  currently:  "Building scalable apps & grinding LeetCode 🧠",
  askMeAbout: ["Clean Architecture", "REST APIs", "OOP", "Data Structures"],
