...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=700&lines=Open+Source+Application+Developer+%F0%9F%9A%80;Node.js+%7C+Angular+%7C+REST+APIs;Building+scalable%2C+maintainable+software;52%2B+repos+and+still+shipping..." alt="Typing SVG" />
</a>

<br/><br/>

<!-- Social Badges -->
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/muhanad-medhat-60a4842a4)
...
const muhanad: Developer = {
  ...
  focusedOn: [
    ...
    "Scalable Node.js & Angular architectures",
    "Clean code, design patterns & SOLID principles",
    "Data Structures, Algorithms & competitive programming",
  ],

  openTo:    ["Full-Stack roles", "Open Source contributions", "Freelance projects"],
};
```
...
[![LeetCode Stats](https://leetcard.jacoblin.cool/muhanad_medhat?theme=dark&font=Fira%20Code&ext=heatmap)](https://leetcode.com/u/muhanad_medhat/)

</div>

- 💡 Passionate about **Data Structures & Algorithms**
- 🔁 Consistent practice in **Arrays, Strings, DP, Trees & Graphs**
- 🏆 Always pushing for cleaner, more optimal solutions
...
📦 Clean Architecture (N-Tier)
 ┣ 📂 Presentation Layer   →  Angular / React / Controllers
 ┣ 📂 Business Logic Layer →  Node.js Services / Express Middleware
 ┣ 📂 Data Access Layer    →  Mongoose / EF Core / Repositories
...
[![LinkedIn](https://img.shields.io/badge/Let's_connect_on_LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/muhanad-medhat-60a4842a4)
